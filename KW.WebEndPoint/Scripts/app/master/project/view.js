define(function(require, exports, module) {
    ...
    module.exports = LayoutManager.extend({
        ...
        initialize: function() {
            ...
            this.listenTo(eventAggregator, 'master/project/add:fecth', function() {
              self.fetchData();
            });
            this.listenTo(eventAggregator, 'master/project/edit:fecth', function() {
             self.fetchData();
            });
            this.listenTo(eventAggregator, 'master/project/delete:fecth', function(model) {
              self.fetchData();
            });
        },
