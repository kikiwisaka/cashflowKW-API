define(function(require, exports, module) {
    ...
    module.exports = LayoutManager.extend({
        ...
        initialize: function() {
            ...
            this.listenTo(eventAggregator, 'master/stage/add:fecth', function() {
              self.fetchData();
            });
            this.listenTo(eventAggregator, 'master/stage/edit:fecth', function() {
             self.fetchData();
            });
            this.listenTo(eventAggregator, 'master/stage/delete:fecth', function(model) {
              self.fetchData();
            });
        },
