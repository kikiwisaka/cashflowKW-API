define(function(require, exports, module) {
    ...
    module.exports = LayoutManager.extend({
        ...
        initialize: function() {
            ...
            this.listenTo(eventAggregator, 'master/comment/add:fecth', function() {
                self.fetchData();
            });
            this.listenTo(eventAggregator, 'master/comment/edit:fecth', function() {
                self.fetchData();
            });
            this.listenTo(eventAggregator, 'master/comment/delete:fecth', function(model) {
                self.fetchData();
            });
        },
        events: {
