define(function(require, exports, module) {
    ...
    module.exports = View.extend({
        ...
        initialize : function(){
          ...
          this.listenToOnce(this.model, 'sync', function(model) {
              ...
              this.listenTo(this.model, 'sync', function() {
                commonFunction.responseSuccessUpdateAddDelete('Functional Risk successfully updated.');
                self.$el.modal('hide');
                eventAggregator.trigger('master/functional_risk/edit:fecth');
              });
          }, this);
        ...
        getConfirmation: function(){
          ...
          // var action = "edit";
          var retVal = confirm("Are you sure want to add Definisi ?");
          if( retVal == true ){
             this.doSave();
          }
          else{
