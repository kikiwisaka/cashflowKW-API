define(function(require, exports, module) {
    ...
    module.exports = LayoutManager.extend({
        ...
        initialize: function() {
            ...
            this.listenTo(eventAggregator, 'master/correlationmatrix/add:fecth', function() {
              self.fetchData();
            });
            this.listenTo(eventAggregator, 'master/correlationmatrix/edit:fecth', function() {
             self.fetchData();
            });
            this.listenTo(eventAggregator, 'master/correlationmatrix/delete:fecth', function(model) {
              self.fetchData();
            });
        },
