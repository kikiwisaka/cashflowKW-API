...
(function(root, factory) {
  ...
  var BackboneModelFileUpload = Backbone.Model.extend({
    ...
    save: function(key, val, options) {
      ...
      if ( options.formData === true || options.formData !== false
          && mergedAttrs[ this.fileAttribute ]
          && mergedAttrs[ this.fileAttribute ] instanceof File || mergedAttrs[ this.fileAttribute ] instanceof FileList || mergedAttrs[ this.fileAttribute ] instanceof Blob ) {
  ...
  Backbone.ModelFileUpload = BackboneModelFileUpload;
