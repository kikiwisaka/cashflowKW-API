...
namespace KW.Presentation.WebAPI.Controllers
{
    public class RiskMatrixProjectController : BaseAPIController
    {
        ...
        public RiskMatrixProjectController(IRiskMatrixProjectService riskMatrixStageService, IRiskRegistrasiService riskRegistrasiService)
        {
        ...
        public IHttpActionResult Get([FromUri] RiskMatrixProjectListParameter param)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    {
                        var result = _riskMatrixStageService.GetAllData().ToList();
        ...
        public IHttpActionResult Get(int id)
        {
            try
            {
                ...
                RiskMatrixProjectDTO riskMatrixStageDTO = RiskMatrixProjectDTO.From(result, riskRegistrasi);
